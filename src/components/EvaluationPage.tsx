  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-4">
        <h1 className="text-3xl font-bold mb-2 luxurious-spacing">
          Space Evaluation
        </h1>
      ...
      {/* Save Evaluation */}
      <div className="bg-card rounded-2xl p-4 premium-shadow max-w-md mx-auto">
        <h3 className="text-lg font-semibold mb-3 text-center">Save Evaluation</h3>
        <div className="space-y-3">
          <Input
            placeholder="Enter place name..."
            value={placeName}
            onChange={(e) => setPlaceName(e.target.value)}
            className="rounded-full px-4 py-3 text-center luxurious-spacing"
            onKeyPress={(e) => e.key === "Enter" && handleSave()}
          />
          <Button
            onClick={handleSave}
            className="w-full rounded-full py-3 luxurious-spacing font-medium dial-smooth"
            size="lg"
          >
            Save Evaluation
          </Button>
